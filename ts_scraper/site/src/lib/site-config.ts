 ...
 * listed above. The grep `git grep job_filters.today` is the audit.
 */
export const SITE_ORIGIN = "https://job_filters.today" as const;
 ...
 */
export const SITE_HOST = "job_filters.today" as const;
 ...
 */
export const REPO_URL = "https://github.com/icebyte/job_filters" as const;
