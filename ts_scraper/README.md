...
[![Build + deploy](https://github.com/icebyte/job_filters/actions/workflows/build-deploy.yml/badge.svg)](https://github.com/icebyte/job_filters/actions/workflows/build-deploy.yml)
[![Nightly scrape](https://github.com/icebyte/job_filters/actions/workflows/scrape.yml/badge.svg)](https://github.com/icebyte/job_filters/actions/workflows/scrape.yml)
[![PR checks](https://github.com/icebyte/job_filters/actions/workflows/pr.yml/badge.svg)](https://github.com/icebyte/job_filters/actions/workflows/pr.yml)
[![Live roles](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fjob_filters.today%2Fdata%2Fmanifest.json&query=%24.total_rows&label=live%20roles&color=brightgreen)](https://job_filters.today/)
[![Last refreshed](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fjob_filters.today%2Fdata%2Fmanifest.json&query=%24.built_at&label=last%20refreshed&color=blue)](https://job_filters.today/)
[![Code: MIT](https://img.shields.io/badge/code-MIT-blue.svg)](LICENSE)
[![Data: CC BY-SA 4.0](https://img.shields.io/badge/data-CC%20BY--SA%204.0-blue.svg)](LICENSE-DATA)
[![GitHub Repo stars](https://img.shields.io/github/stars/icebyte/job_filters?style=social)](https://github.com/icebyte/job_filters/stargazers)

[![job_filters in action](.github/assets/screenshot-desktop.png)](https://job_filters.today/)

<details>
<summary><strong>Dark mode &amp; mobile</strong></summary>

<p>
  <img alt="job_filters in dark mode" src=".github/assets/screenshot-dark.png" />
</p>

<p>
  <img alt="job_filters on mobile" src=".github/assets/screenshot-mobile.png" width="320" />
</p>

</details>

> [!NOTE]
> Live at **https://job_filters.today/**.
> Refreshed every night.

## What it is

`job_filters` scrapes the public APIs of 51 hiring platforms each
...
| Query | URL |
|---|---|
| Senior + staff engineers on Greenhouse or Lever, remote-only, last 7 days | [`?ats=greenhouse,lever&level=senior,staff&wt=remote&since=7d`](https://job_filters.today/?ats=greenhouse,lever&level=senior,staff&wt=remote&since=7d) |
| "Staff engineer" anywhere in the title, Germany only | [`?q=title:"staff engineer"&country=DE`](https://job_filters.today/?q=title%3A%22staff+engineer%22&country=DE) |
| Stripe, all roles | [`?q=company:stripe`](https://job_filters.today/?q=company%3Astripe) |
| Hide recruiter posts + hide stale carry-forwards | [`?recruiter=0&hide_stale=1`](https://job_filters.today/?recruiter=0&hide_stale=1) |
...
[Feashliaa/job_filters](https://github.com/Feashliaa/job_filters).
Independent implementation, but credit where credit is due.

## Help spread the word

If `job_filters` saves you time — or you appreciate that it's ad-free,
...
<a href="https://github.com/icebyte/job_filters/stargazers">
  <img alt="Stargazers over time" src="https://starchart.cc/icebyte/job_filters.svg" />
</a>

Copyright © 2026 icebyte.
