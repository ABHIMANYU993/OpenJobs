...
import { ATS_IDS, type ATSId, SCHEMA_VERSION, type Tenant, TenantSchema } from "@job_filters/shared";
import { z } from "zod";
...
const CONTACT_URL = process.env["CONTACT_URL"] ?? "https://github.com/icebyte/job_filters";
const UA = process.env["UA"] ?? `job_filters/${SCHEMA_VERSION} (+${CONTACT_URL})`;
