<div align="center">
  <img src="docs/screenshot.png" alt="Open Jobs UI" width="100%">
...
*Note: To make the UI screenshot appear at the top of this README, please place the screenshot image inside a `docs/` folder at the root of the repository and name it `screenshot.png`.*
