...
![Job Filters - table view with salary and ATS data](docs/screenshot-table.png)
...
[View Job Board](https://icebyte.github.io/job_filters)
...
```bash
git clone https://github.com/Feashliaa/job_filters.git
cd job_filters
